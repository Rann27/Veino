...
function VoucherEditContent({ voucher }: Props) {
    ...
    return (
        <div>
            <div style={{ marginBottom: '24px' }}>
                <h1 style={{ fontSize: '24px', fontWeight: 700, color: fg }}>Edit Voucher</h1>
            </div>
            ...
            <div style={{ background: cardBg, border: `1px solid ${border}`, borderRadius: '12px', padding: '24px' }}>
                <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
                    ...
                    <div>
                        ...
                        <input type="text" value={formData.code} onChange={handleCodeChange} style={inputStyle(!!errors.code)} required />
                    ...
                    <div>
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            ...
                            <div>
                                <input type="number" min="1" value={formData.usage_limit} onChange={(e) => setFormData(p => ({ ...p, usage_limit: e.target.value }))} style={inputStyle(!!errors.usage_limit)} required />
                    ...
                    <div>
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            ...
                            <div>
                                <input type="number" min="0" step="0.01" value={formData.discount_value} onChange={(e) => setFormData(p => ({ ...p, discount_value: e.target.value }))} style={inputStyle(!!errors.discount_value)} required />
...
export default function VoucherEdit({ voucher }: Props) {
    return (
        <AdminLayout title={`Edit Voucher - ${voucher.code}`}>
            <Head title={`Edit Voucher - ${voucher.code}`} />
            <VoucherEditContent voucher={voucher} />
        </AdminLayout>
    );
}
