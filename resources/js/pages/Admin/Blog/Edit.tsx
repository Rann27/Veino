...
interface Blog { id: number; title: string; content: string; show_in_homepage: boolean; }
interface Props { blog: Blog; }

function EditContent({ blog }: Props) {
        ...
        <div style={{ color: fg, padding: '2rem 1rem', minHeight: '100vh' }}>
            <div style={{ maxWidth: '56rem', margin: '0 auto' }}>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', marginBottom: '2rem', flexWrap: 'wrap' }}>
                    ...
                    <h1 style={{ fontSize: '1.5rem', fontWeight: 700, color: fg, margin: 0 }}>Edit Blog</h1>
                </div>

                {/* Blog title subheader */}
                <p style={{ fontSize: '0.875rem', color: muted, marginBottom: '1.5rem', marginTop: '-1rem' }}>
                    {blog.title}
                </p>
