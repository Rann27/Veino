...
function BookshelfContent({ seriesGroups }: Props) {
    ...
    const downloadPdf = (itemId: number) => {
        ...
        // Create temporary link to trigger download
        const link = document.createElement('a');
        link.href = route('ebook.download.pdf', itemId);
                                                        ...
                                                        <div className="flex gap-2 mt-auto">
                                                            {item.can_download && (
                                                                <button
                                                                    ...
                                                                    className="flex-1 px-3 py-1.5 rounded font-semibold text-xs transition-all duration-200 hover:opacity-90 disabled:opacity-50"
                                                                    style={{
